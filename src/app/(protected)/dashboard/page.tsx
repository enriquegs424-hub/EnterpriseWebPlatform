...
export default async function DashboardPage() {
    ...
    return (
        <div className="space-y-6">
            {/* Header */}
            <div>
                <h1 className="text-3xl font-black text-neutral-900 dark:text-neutral-50">Panel de Control</h1>
                <p className="text-neutral-500 dark:text-neutral-400 font-medium mt-1">Resumen de tu actividad y tareas pendientes</p>
            </div>
            ...
            {projectBreakdown.length > 0 && (
                <div className="bg-white dark:bg-neutral-900 rounded-2xl p-6 border border-neutral-200 dark:border-neutral-800 shadow-sm">
                    <div className="flex items-center space-x-3 mb-6">
                        ...
                        <div>
                            <h3 className="font-bold text-neutral-900 dark:text-neutral-100">Distribución por Proyecto</h3>
                            <p className="text-sm text-neutral-500 dark:text-neutral-400">Horas registradas este mes</p>
                        </div>
                    </div>
                                ...
                                <div key={project.projectId} className="space-y-2">
                                    <div className="flex justify-between items-center">
                                        <div className="flex items-center space-x-3">
                                            <span className="font-bold text-neutral-900 dark:text-neutral-200">{project.code}</span>
                                            <span className="text-sm text-neutral-500 dark:text-neutral-400">{project.name}</span>
                                        </div>
                                        <span className="font-bold text-neutral-900 dark:text-neutral-200">{project.hours}h</span>
                                    </div>
                ...
                <div className="bg-white dark:bg-neutral-900 rounded-2xl p-6 border border-neutral-200 dark:border-neutral-800 shadow-sm">
                    <div className="flex items-center justify-between mb-6">
                        <div className="flex items-center space-x-3">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-neutral-500 dark:text-neutral-400">Últimas {stats.recentEntries.length} entradas</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="space-y-3">
                        {stats.recentEntries.map((entry: any) => (
                            <div key={entry.id} className="flex items-center justify-between p-4 bg-neutral-50 dark:bg-neutral-800/50 rounded-xl hover:bg-neutral-100 dark:hover:bg-neutral-800 transition-all border border-transparent dark:border-neutral-800">
                                <div className="flex items-center space-x-4">
                                    <div className="flex flex-col items-center justify-center w-12 h-12 bg-white dark:bg-neutral-900 rounded-lg border border-neutral-200 dark:border-neutral-700">
                                    ...
                                    <div>
                                        <p className="font-bold text-neutral-900 dark:text-neutral-200">{entry.project.code}</p>
                                        <p className="text-sm text-neutral-500 dark:text-neutral-400">{entry.project.name}</p>
                                        {entry.notes && (
            ...
            {/* Empty State */}
            {stats.recentEntries.length === 0 && (
                <div className="bg-neutral-50 dark:bg-neutral-900/50 rounded-3xl p-20 text-center border-2 border-dashed border-neutral-200 dark:border-neutral-800">
                    <Clock size={64} className="mx-auto text-neutral-200 dark:text-neutral-700 mb-4" />
                    <h3 className="text-xl font-bold text-neutral-400 dark:text-neutral-500 mb-2">Sin registros este mes</h3>
                    <p className="text-neutral-400 dark:text-neutral-600 mb-6">Comienza a registrar tus horas de trabajo</p>
                    <a
                        href="/hours/daily"
