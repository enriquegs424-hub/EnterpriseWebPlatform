        ...
        <div className="w-80 border-r border-neutral-200 bg-white flex flex-col h-full">
            ...
            <div className="p-4 border-b border-neutral-200">
                <div className="flex items-center justify-between mb-4">
                    <h2 className="text-xl font-black text-neutral-900">Mensajes</h2>
                </div>
                ...
                <div className="relative">
                    ...
                    <input
                        ...
                        className="w-full pl-9 pr-3 py-2 text-sm border border-neutral-200 rounded-lg focus:border-olive-500 focus:outline-none"
                    />
                </div>
            </div>
                                ...
                                {filteredChats.map((chat) => {
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={`w-full px-4 py-3 text-left hover:bg-neutral-50 transition-colors border-l-4 ${isSelected
                                        ...
                                        >
                                            <div className="flex items-start justify-between gap-2 mb-1">
                                                <div className="flex-1 min-w-0">
                                                    <h3 className={`font-bold text-sm truncate ${isSelected ? 'text-olive-900' : 'text-neutral-900'
                                                        }`}>
                                                        {displayName}
                                                    </h3>
                            ...
                            <div className="py-2 border-t border-neutral-200">
                                ...
                                {availableUsers.map((user) => (
                                    <button
                                        ...
                                        className="w-full px-4 py-3 text-left hover:bg-neutral-50 transition-colors border-l-4 border-transparent hover:border-olive-300"
                                    >
                                        <div className="flex items-start gap-3">
                                            <div className="w-10 h-10 rounded-full bg-olive-100 flex items-center justify-center text-olive-700 font-bold text-sm flex-shrink-0">
